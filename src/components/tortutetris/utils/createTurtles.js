export const createTurtles = () => [
  ...
  { id: 1, x: 5, y: 0, moveX: 0, moveY: 0, moveUpdate: false, status: undefined, gravityCounter: 0, sprite: '🐢' },  
  { id: 2, x: 6, y: 0, moveX: 0, moveY: 0, moveUpdate: false, status: undefined, gravityCounter: 0, sprite: '🐢' },
  { id: 2, x: 7, y: 0, moveX: 0, moveY: 0, moveUpdate: false, status: undefined, gravityCounter: 0, sprite: '🐢' },
  { id: 2, x: 8, y: 0, moveX: 0, moveY: 0, moveUpdate: false, status: undefined, gravityCounter: 0, sprite: '🐢' },  
  ...
  { id: 3, x: 9, y: 0, moveX: 0, moveY: 0, moveUpdate: false, status: undefined, gravityCounter: 0, sprite: '🐢' },  
